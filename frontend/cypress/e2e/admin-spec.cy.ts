describe('Strona administratora', () => {
  ...
  it('Strona dashboardu', () => {
    ...
    cy.get('app-dashboard-card')
      .first()
      .contains('Liczba użytkowników')
      .should('be.visible');
    cy.get('app-dashboard-card')
      .eq(1)
      .contains('Liczba lekarzy')
      .should('be.visible');
    cy.get('app-dashboard-card')
      .eq(2)
      .contains('Liczba wniosków')
      .should('be.visible');
    cy.get('app-dashboard-card')
      .eq(3)
      .contains('Liczba leków')
      .should('be.visible');
    cy.get('app-dashboard-card')
      .eq(4)
      .contains('Liczba parametrów')
      .should('be.visible');
    cy.get('app-dashboard-card')
      .last()
      .contains('Liczba aktywności')
      .should('be.visible');
  });
  it('Strona wniosków', () => {
  ...
  it('Strona parametrów', () => {
    ...
    cy.get('app-header-bar')
      .contains('Zarządzanie parametrami')
      .should('be.visible');
  ...
  it('Strona aktywności', () => {
    ...
    cy.get('app-header-bar')
      .contains('Zarządzanie aktywnościami')
      .should('be.visible');
  ...
  it('Strona aktywności', () => {
    ...
    cy.get('app-header-bar')
      .contains('Zarządzanie użytkownikami')
      .should('be.visible');

...
export class ErrorCodesService {
  private readonly errorCodes: { [key: number]: ErrorCode } = {
    ...
    301: { message: 'Token weryfikacyjny wygasł', status: 'UNAUTHORIZED' },
    ...
    305: { message: 'Nieprawidłowa weryfikacja lub nieprawidłowy token weryfikacyjny', status: 'FORBIDDEN' },

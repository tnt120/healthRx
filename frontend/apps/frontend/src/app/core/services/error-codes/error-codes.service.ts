...
export class ErrorCodesService {
  private readonly errorCodes: { [key: number]: ErrorCode } = {
    ...
    301: {
      message:
        'Link aktywacyjny stracił ważność, link z nowym kodem został wysłany na email',
      status: 'UNAUTHORIZED',
    },
    ...
    305: {
      message:
        'Podany link weryfikacyjny jest błędny. Poprawny link powinen znajdować się na twojej skrzynce email',
      status: 'FORBIDDEN',
    },
    306: {
      message: 'Konto z podanym adresem e-mail nie istnieje',
      status: 'FORBIDDEN',
    },
    307: {
      message:
        'Konto nie zostało zweryfikowane. Zweryfikuj swoje konto aby móc się zalogować.',
      status: 'FORBIDDEN',
    },
    308: { message: 'Użytkownik nie znaleziony', status: 'NOT_FOUND' },
    309: { message: 'Podany parametr nie znaleziony', status: 'NOT_FOUND' },
    310: {
      message: 'Log parametrów już istnieje. Nieprawidłowa wiadomość',
      status: 'BAD_REQUEST',
    },
    311: { message: 'Log parametrów nie znaleziony', status: 'NOT_FOUND' },
    312: {
      message: 'Użytkownik próbuje zmodyfikować dane innej osoby',
      status: 'FORBIDDEN',
    },
    321: { message: 'Niepoprawne aktualne hasło', status: 'BAD_REQUEST' },
    322: { message: 'Hasła do siebie nie pasują', status: 'BAD_REQUEST' },
    323: {
      message: 'Nowe hasło jest takie samo jak stare hasło',
      status: 'BAD_REQUEST',
    },
    343: {
      message:
        'Parametr z podaną nazwą już istnieje. Spróbuj ponownie z inną nazwą.',
      status: 'CONFLICT',
    },
    344: {
      message:
        'Aktywność z podaną nazwą już istnieje. Spróbuj ponownie z inna nazwą.',
      status: 'CONFLICT',
    },

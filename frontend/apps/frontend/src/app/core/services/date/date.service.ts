...
export class DateService {
  private dateRangeCalculators = new Map<
    DateRangeType,
    () => { from: Date; to: Date }
  >([
    ['today', () => this.getLastDaysRange(0)],
    ['currentWeek', () => this.getWeekRange(0)],
    ['currentMonth', () => this.getMonthRange(0)],
    ['previousWeek', () => this.getWeekRange(-1)],
    ['previousMonth', () => this.getMonthRange(-1)],
    ['last7Days', () => this.getLastDaysRange(7)],
    ['last30Days', () => this.getLastDaysRange(30)],
    ['last60Days', () => this.getLastDaysRange(60)],
    ['last90Days', () => this.getLastDaysRange(90)],
    ['last120Days', () => this.getLastDaysRange(120)],
    ['last180Days', () => this.getLastDaysRange(180)],
    ['last365Days', () => this.getLastDaysRange(365)],
    ['currentYear', () => this.getYearRange(0)],
    ['previousYear', () => this.getYearRange(-1)],
  ]);

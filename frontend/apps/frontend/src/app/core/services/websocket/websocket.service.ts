...
export class WebsocketService {
  ...
  constructor() {
    ...
    this.stompClientMessages = Stomp.over(
  ...
  subscribeToChat() {
    ...
    this.chatSubscription = this.stompClientMessages.subscribe(
    ...
    this.readMessageSubscription = this.stompClientMessages.subscribe(
      `/user/${this.userId}/queue/messages/read`,
      (message) => {
        const body: ChatMessageDto = JSON.parse(message.body);

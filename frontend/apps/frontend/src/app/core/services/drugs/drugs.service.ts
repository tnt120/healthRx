...
export class DrugsService {
  ...
  getDrugs(
  ...
  ): Observable<PageResponse<DrugResponse>> {
    ...
    return this.http
      .get<PageResponse<DrugResponse>>(`${this.apiUrl}`, { params })
      .pipe(
        finalize(() => {
  ...
  getUserDrugs(
    ...
    size: number,
    sort: SortOption
  ): Observable<PageResponse<UserDrugsResponse>> {
    let params = new HttpParams()
      .set('page', page.toString())
      .set('size', size.toString())
      .set('sortBy', sort.sortBy)
    ...
    this.setLoadingDrugsState(true);
    return this.http
      .get<PageResponse<UserDrugsResponse>>(`${this.apiUrl}/user`, { params })
      .pipe(
        finalize(() => {
          this.setLoadingDrugsState(false);
        })
  ...
  updateUserDrug(
    request: UserDrugsRequest,
    id: string
  ): Observable<UserDrugsResponse> {
    return this.http.put<UserDrugsResponse>(
      `${this.apiUrl}/user/${id}`,
      request
    );
  }
  ...
  getUserDrugMonitor(): Observable<UserDrugMonitorResponse[]> {
    ...
    return this.http
      .get<UserDrugMonitorResponse[]>(`${this.apiUrl}/monitor`)
      .pipe(
        tap(() => {
  ...
  setMonitorDrug(
    request: UserDrugMonitorRequest
  ): Observable<UserDrugMonitorResponse> {
    return this.http.post<UserDrugMonitorResponse>(
      `${this.apiUrl}/monitor`,
      request
    );
  }
  ...
  editMonitorDrug(
    ...
    return this.http.patch<UserDrugMonitorResponse>(
      `${this.apiUrl}/monitor`,
      request
    );
  }
  ...
  deleteMonitorDrug(drugId: number, time: string): Observable<void> {
    let params = new HttpParams().set('drugId', drugId).set('time', time);
